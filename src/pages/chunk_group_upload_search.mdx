export const description =
  'Guide on how to upload your chunks with a group and search them.'

# File Upload and Search Guide

This guide will walk you through the process of creating chunk groups that contain your chunks and searching for them. 
