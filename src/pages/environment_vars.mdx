...
| ONLY_ADMIN_CAN_CREATE_CARDS  | "on" or "off" if on only the admin user defined below will be allowed to create chunks                                                                                   |
...
| PUBLIC_FRONTMATTER_VALS        | keys of the JSON metadata for a document chunk (aka `chunk`) that you want to display in the UI, i.e. `["author,email_sent,email_subject,email_cc]`                                                                                                                                                        |
...
| ENV                         | DESCRIPTION                                                                                                                                        |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| VITE_FRONTMATTER_VALS       | keys of the JSON metadata for a document chunk (aka `chunk`) that you want to display in the UI, i.e. `["author,email_sent,email_subject,email_cc]` |
