...
<Row>
  <Col>
    ...
    This route allows you to invite a user to register for Trieve vault. The user will receive an email with a link to set their password.
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST \
      https://api.trieve.ai/invitation \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST \
      https://api.trieve.ai/register/{invitation_id} \
      -H 'Content-Type: application/json' \
      -H 'Cookie: ai-editor=your_cookie_value_here' \
      -d '{
          "password": "password",
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --request GET \
      --url https://api.trieve.ai/api/password/foobar@bar.com \
      --cookie 'ai-editor=your_cookie_value_here'
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl --request POST \
        --url https://api.trieve.ai/api/password \
        --header 'Content-Type: application/json' \
        --data '{
          "email": "foobar@bar.com",
      }'
