...
<Row>
  <Col>
    ...
    This endpoint allows you to authenticate a user and retrieve an access token.
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl --request POST \
        --url https://api.arguflow.com/api/auth \
...
<Row>
  <Col>
    ...
    This endpoint allows you to logout a user and invalidate their access token.
...
<Row>
  <Col>
    ...
    This endpoint allows you to get your user info.
...
<Row>
  <Col>
    ...
    This endpoint allows you to send a password reset email to a user.
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --request GET \
      --url https://api.arguflow.com/api/password/foobar@bar.com \
      --cookie ai-editor=your_cookie_value_here
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl --request POST \
        --url https://api.arguflow.com/api/password \
        --header 'Content-Type: application/json' \
        --data '{
          "email": "foobar@bar.com",
      }'
