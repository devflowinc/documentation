...
<Row>
  <Col>
    ...
    This endpoint allows you to get the cards and votes for a user, as well as other metadata about the user. 
...
<Row>
  <Col>
    ...
    This endpoint allows you to get the collections for a user.
...
<Row>
  <Col>
    ...
    This endpoint allows you to get the files for a user.
