...
<Row>
  <Col>
    ...
    This endpoint allows you to retrieve a card from the database with using its id. (Must be authenticated and must be your card if private) Refer to [the list](#the-card-model) at the top of this page to see which properties are included with card objects.
