...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location 'https://api.trieve.ai/api/card' \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.trieve.ai/api/card/19ddebb4-fc9f-4a8c-8a37-020b9b8b536d \
       --header 'Cookie: ai-editor=your_cookie_value_here'
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl --location --request PUT 'https://api.trieve.ai/api/card/update' \
          --header 'Content-Type: application/json' \
          --header 'Cookie: ai-editor=your_cookie_value_here' \
          --data '{
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl --G 'https://api.trieve.ai/api/card/search/1' \
        --header 'Content-Type: application/json' \
        --header 'Cookie: ai-editor=your_cookie_value_here' \
        --data '{
            "content": "test"
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl --G 'https://api.trieve.ai/api/card/fulltextsearch/1' \
        --header 'Content-Type: application/json' \
        --header 'Cookie: ai-editor=your_cookie_value_here' \
        --data '{
            "content": "test"
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl --G 'https://api.trieve.ai/api/card/count' \
        --header 'Content-Type: application/json'
    ```
