...
Unfortunately, the Vault API is still in alpha and does not yet have very descriptive error messages. However, we are working on improving this, if you are interested in helping please reach out on [Matrix](https://matrix.to/#/#arguflow-general:matrix.zerodao.gg) or [Github](https://github.com/arguflow/arguflow).
...
<Note>
  ...
  [Github](https://github.com/arguflow/arguflow) and we will help you out.
</Note>
