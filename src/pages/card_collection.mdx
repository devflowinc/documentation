...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl -L -g 'https://api.trieve.ai/api/card_collection' \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://api.trieve.ai/api/card_collection \
      --header 'Cookie: ai-editor=your_cookie_value_here'\
      -d '{
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl -L -X PUT 'https://api.trieve.ai/api/card_collection' \
...
<Row>
  ...
  <Col sticky>
    ...
    curl -L 'https://api.trieve.ai/api/card_collection/65c6dcce-2c4b-4466-874b-d194bcf91ae2/1' \
      -H 'Cookie: ai-editor=your_cookie_value_here'
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -L 'https::api.trieve.ai/api/card_collection/65c6dcce-2c4b-4466-874b-d194bcf91ae2' \
      -H 'Content-Type: application/json' \
      -H 'Cookie: ai-editor=your_cookie_value_here' \
      -d '{
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE 'https::api.trieve.ai/api/card_collection/65c6dcce-2c4b-4466-874b-d194bcf91ae2' \
      -H 'Content-Type: application/json' \
      -H 'Cookie: ai-editor=your_cookie_value_here' \
      -d '{
          "card_metadata_id": "2cbcebbd-81c6-478b-bb29-e84bd3bd7cea"
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl -L 'https::api.trieve.ai/api/card_collection/bookmark' \
            -H 'Content-Type: application/json' \
            -H 'Cookie: ai-editor=your_cookie_value_here' \
            -d '{
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl -L 'https://api.trieve.ai/api/card_collection/search/1' \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl -L 'https://api.trieve.ai/api/card_collection/fulltextsearch/1' \
        --header 'Content-Type: application/json' \
        --header 'Cookie: ai-editor=your_cookie_value_here' \
        --data '{
            "content": "test",
