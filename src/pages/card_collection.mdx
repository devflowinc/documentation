...
Collections are groups of cards that are either user created, or automatically created from files that are uploaded. On this page, we'll dive into how to manage collections progrmatically. {{ className: 'lead' }}
...
<Row>
  ...
  <Col sticky>
    ...
    await client.collections.delete('L7cGNIBKZiNJ6wqF')
    ```
    ...
    client.collections.delete("L7cGNIBKZiNJ6wqF")
    ```
...
<Row>
  <Col>
    ...
    This endpoint allows you to search a collection using full-text.
