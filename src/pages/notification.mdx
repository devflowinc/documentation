...
<Properties>
  ...
  <Property name="chunk_uuid" type="string">
    Unique identifier for the chunk that the notification belongs to.
  </Property>
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
      curl -L 'https://api.trieve.ai/api/notifications' \
      ...
      [
            {
              ...
              "chunk_uuid": "6aa69c6b-61a3-4ef8-804d-8ed08e4608bd",
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.trieve.ai/api/notifications \
      -H 'Cookie: ai-editor=your_cookie_value_here' \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.trieve.ai/api/notifications/all \
      -H 'Cookie: ai-editor=your_cookie_value_here' 
    ```
