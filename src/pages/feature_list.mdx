...
Additionally the [demo of Vault](https://vault.arguflow.com/) is free for all. You can sign up for an account at [vault.arguflow.com](https://vault.arguflow.com/).
...
If you have a competitive background and are using the demo client at [vault.arguflow.com](https://vault.arguflow.com/) then you may be interested to know that to some extent, searching for theory like Kritiks, Counterplans, and Disadvantages is possible with semantic search.

[![Semantic search](/vault-semantic-search.png)](https://vault.arguflow.com/)
...
[![Lexical search](/vault-full-text-search.png)](https://vault.arguflow.com/)

## 3. Filtering evidence from the OpenCaselist wiki by school, year, file name, and more
...
[![Filtering](/vault-custom-filters.png)](https://vault.arguflow.com/)

## 4. Filtering evidence based on source URL (reuters, nyt, Washington Post, etc.)
...
[![Filtering](/vault-custom-url-filters.png)](https://vault.arguflow.com/)

## 5. Case brief upload and parse
...
[![Case brief upload](/vault-upload-file.png)](https://vault.arguflow.com/)
...
[![Private case brief](/vault-private-case-brief.png)](https://vault.arguflow.com/)

## 6. Creating collections of evidence cards
...
Collections can be shared with other users via sending them a link. Currently collections are always public, however, the evidence within them can be private. This means that if you create a collection and add private evidence to it, then the collection will be public but the evidence within it will only be visible to you.

[![Create collection](/vault-create-collection.png)](https://vault.arguflow.com/)

## 7. Creating evidence cards
...
[![Create card](/vault-create-evidence.png)](https://vault.arguflow.com/)
...
[![Private card](/vault-create-private-evidence.png)](https://vault.arguflow.com/)
...
[![Duplicate detection](/vault-duplicate-detection.png)](https://vault.arguflow.com/)
...
[![Verified card](/vault-verified-evidence.png)](https://vault.arguflow.com/)

## 10. Voting on evidence
...
[![Vote on evidence](/vault-card-voting.png)](https://vault.arguflow.com/)
...
[![User score](/vault-user-information.png)](https://vault.arguflow.com/)
...
[![User settings](/vault-settings.png)](https://vault.arguflow.com/)

## 12. View top contributors
...
[![Top contributors](/vault-top-contributors.png)](https://vault.arguflow.com/)
...
## 13. Update your evidence cards' syntax highlighting
...
[![Update syntax highlighting](/vault-update-syntax-highlighting.png)](https://vault.arguflow.com/)

## 14. View individual evidence card
...
[![View card](/vault-view-card.png)](https://vault.arguflow.com/)

## 15. Delete your evidence cards
...
[![Delete card](/vault-delete-card.png)](https://vault.arguflow.com/)